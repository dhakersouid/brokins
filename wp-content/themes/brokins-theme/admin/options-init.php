<?php
    ...
    $opt_name = "redux_builder_dhakersouid";
    ...
    $args = array(
        ...
        'dev_mode' => TRUE,
        'use_cdn' => TRUE,
        'display_name' => 'brokins',
        'display_version' => '0.0.1',
        'page_title' => 'Brokins Options',
        'update_notice' => TRUE,
        'admin_bar' => TRUE,
        'menu_type' => 'menu',
    ...
    $tabs = array(
        array(
            'id'      => 'redux-help-tab-1',
            'title'   => __( 'Theme Information 1', 'brokins_theme' ),
            'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'brokins_theme' )
        ),
        array(
            'id'      => 'redux-help-tab-2',
            'title'   => __( 'Theme Information 2', 'brokins_theme' ),
            'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'brokins_theme' )
        )
    );
    ...
    $content = __( '<p>This is the sidebar content, HTML is allowed.</p>', 'brokins_theme' );
